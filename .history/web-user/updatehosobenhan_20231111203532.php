                                ...
                                <div class="col-md-6">
                                    ...
                                    <div style="width:460px" class="mt-3">
                                        ...
                                        <select class="form-control" id="ngheNghiep" name="ngheNghiep">
                                            ...
                                            <?php
                                            $ngheNghiepOptions = array("Option1", "Option2", "Option3");
                                    ...
                                    <div style="width:460px" class="mt-3">
                                        ...
                                        <select class="form-control" id="tinhThanh" name="tinhThanh">
                                            ...
                                            <?php
                                            $tinhThanhOptions = array("Option1", "Option2", "Option3");
                                    ...
                                    <div style="width:460px" class="mt-3">
                                        ...
                                        <select class="form-control" id="phuongXa" name="phuongXa">
                                            ...
                                            <?php
                                            $phuongXaOptions = array("Option1", "Option2", "Option3");
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div style="width:460px" class="mt-3">
                                        ...
                                        <select class="form-control" id="gioiTinh" name="gioiTinh">
                                            ...
                                            <?php
                                            $gioiTinhOptions = array("Option1", "Option2", "Option3");
                                    ...
                                    <div style="width:460px" class="mt-3">
                                        ...
                                        <select class="form-control" id="danToc" name="danToc">
                                            ...
                                            <?php
                                            $danTocOptions = array("Option1", "Option2", "Option3");
                                    ...
                                    <div style="width:460px" class="mt-3">
                                        ...
                                        <select class="form-control" id="quanHuyen" name="quanHuyen">
                                            ...
                                            <?php
                                            $quanHuyenOptions = array("Option1", "Option2", "Option3");

                                            foreach ($quanHuyenOptions as $option) {
                                                echo "<option value=\"$option\"";
                                                if ($option === $quanHuyen) {
                                                    echo " selected";
                                                }
