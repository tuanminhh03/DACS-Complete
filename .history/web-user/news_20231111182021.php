                            ...
                            <div class="card-wrapper d-flex">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <p class="y-l" style="font-size: 13px;"><i class="fa-solid fa-calendar-days"
                                                style="margin-right: 5px;"></i>22/12/2023</p>
                                        <p class="x-l" style="color: aqua;cursor: pointer;">Xem tiếp<i
                                                class="fa-solid fa-arrow-right" style="margin-left: 10px;"></i></p>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="image-content">
                                    ...
                                    <div class="card-content">
                                        <li><a href="">Tin dịch vụ</a></li>
                                        <div class="style_title_info">
                                            PHÒNG KHÁM XÉT NGHIỆM CÔNG NGHỆ CAO HEALTH CARE VIỆT NAM CHÍNH THỨC GIA NHẬP
                                            NỀN TẢNG MEDPRO
                                        </div>
                                        <p class="y-l" style="font-size: 13px;"><i class="fa-solid fa-calendar-days"
                                                style="margin-right: 5px;"></i>22/12/2023</p>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <li><a href="">Tin dịch vụ</a></li>
                                        <div class="style_title_info">
                                            Vì Sức Khoẻ Cộng Đồng - Miễn phí Cuộc gọi Video cùng Bác Sĩ thật trên ứng
                                            dụng Medpro
                                        </div>
                                        <p class="y-l" style="font-size: 13px;"><i class="fa-solid fa-calendar-days"
                                                style="margin-right: 5px;"></i>22/12/2023</p>
                                ...
                                <div class="card-wrapper d-flex" style="width: 350px; margin-right: 35px;">
                                    <div class="card_tyt">
                                        ...
                                        <div class="card-content_tyt">
                                            ...
                                            <div class="title_content_tyt">viện Đa khoa Quốc tế Nam Sài Gòn là một trong
                                                những bệnh viện
                                    ...
                                    <div class="card_yhtt">
                                        <div class="image_content_yhtt">
                                            ...
                                            <div class="card_content_yhtt">
                                                ...
                                                <div class="title_content_yhtt">viện Đa khoa Quốc tế Nam Sài Gòn là một
                                                    trong những bệnh viện
                                                    tư nhân uy tín hàng đầu tại Thành phố Hồ Chí Minh, chuyên khám
                                                    và điều trị các bệnh lý về cột sống, thần kinh và cơ xương khớp.
                                                    Với đội ngũ y bác sĩ giỏi, giàu kinh nghiệm, cùng với cơ sở vật
                                                    chất, trang thiết bị y tế hiện đại, bệnh viện mang đến cho người
                                                    bệnh trải nghiệm khám chữa bệnh chất lượng cao.</div>
                                                <p class="y-l" style="font-size: 13px;"><i
                                                        class="fa-solid fa-calendar-days"
                                                        style="margin-right: 5px;"></i>22/12/2023</p>
                                                <p class="x-l" style="color: aqua;cursor: pointer;">Xem tiếp<i
                                                        class="fa-solid fa-arrow-right" style="margin-left: 10px;"></i>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="conten_header">
                                        <div class="style_info_right"
                                            style="margin-left: 35px; width: 400px;padding-top: 15px;">
                                            <li><a href="">Y học thường thức</a></li>
                                            <div class="title_text">
                                                Bệnh đậu mùa khỉ: nguyên nhân, triệu chứng và cách điều trị
                                            </div>
                                            <div class="title_text2">
                                                Thông tin chi tiết về bệnh đậu mùa khỉ, triệu chứng, các cách bảo vệ sức
                                                khỏe và tránh nhiễm bệnh hoặc xử lý khi phát hiện những dấu hiệu ban đầu
                                                của bệnh.
                                            </div>
                                        </div>
