...
<head>
    ...
    <link rel="stylesheet" href="./assest/css/xacnhan.css">
    ...
    <div class="all1">
        <div style="display: flex;">
            <div class="left">
                ...
                <div class="left2">
                    <h5>Bệnh viện Đại học Y Dược TP.HCM</h5>
                    ...
                    <div class="right22">
                        <div class="patient-info">
                            ...
                            if (isset($_SESSION["username"])) {
                                ...
                                // Truy vấn dữ liệu từ cơ sở dữ liệu (ví dụ: lấy thông tin người dùng)
                                $query = "SELECT * FROM ten_bang WHERE username = ?";
                                $stmt = $conn->prepare($query);
                                $stmt->bind_param("s", $username);
                                $stmt->execute();
                                ...
                                echo '<div class="right22">';
                                echo '<div class="patient-info">';

                                while ($row = $result->fetch_assoc()) {
                                    echo '<div class="patient-info-item">';
                                    echo '<p>Họ tên: ' . $row['hoTen'] . '</p>';
                                    echo '<p>Ngày sinh: ' . $row['ngaySinh'] . '</p>';
                                    echo '<p>Email: ' . $row['email'] . '</p>';
                                    echo '<p>Mã số BHYT: ' . $row['maSoBHYT'] . '</p>';
                                    echo '</div>';

                                    echo '<div class="patient-info-item">';
                                    echo '<p>Giới tính: ' . $row['gioiTinh'] . '</p>';
                                    echo '<p>CMND: ' . $row['soCMND'] . '</p>';
                                    echo '<p>Dân tộc: ' . $row['danToc'] . '</p>';
                            ...
                            <div class="patient-info-item">
                                ...
                                <p>Ngày sinh: 04/01/1999</p>
                                <p>Email: nguyenvanb@gmail.com</p>
                                <p>Mã số BHYT: Chưa cập nhật</p>
                            </div>
                            <div class="patient-info-item">
                                <p>Giới tính: Nam</p>
                                <p>CMND: 01234567891</p>
                                <p>Dân tộc: Kinh</p>
                                <p>Địa chỉ: Yên Nghĩa, Phường Yên Nghĩa, Quận Hà Đông, Thành phố Hà Nội</p>
                            </div>
                        </div>
                    </div>
                    <div style="display: flex;">
                        <div class="right3">
                            <a href="./index.php" style=" text-decoration: none; ">
                                <p style="font-size: 20px;">Quay lại</p>
                            </a>
                        </div>
                        <div class="right4">
                            <div class="right41">
                                <a href="" style=" text-decoration: none;color: white; ">Thêm chuyên khoa</a>
                            </div>
                            <div class="right42">
                                <a href="./index.php" style=" text-decoration: none; color: white;">Xác nhận</a>
                            </div>
                        </div>
                    </div>
                </div>
