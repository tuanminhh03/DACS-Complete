...
<body>
                    ...
                    <div class="doccure_info">
                        <div class="nav-item d-flex">
                            ...
                            <div class="style_user">
                                ...
                                <div class="subnav">
                                    <a href="./hosobenhnhan.html"><i class="fa-solid fa-address-card"
                                            style="margin-right: 15px;"></i>Hồ Sơ Bệnh Nhân</a>
                                    <a href="#"><i class="fa-solid fa-calendar-days"
    ...
    <footer>
        <p> Name: Nguyen Danh Diep<br>
            <a href="#">21012491@st.phenikaa-uni.edu.vn</a>
        </p>
    </footer>
