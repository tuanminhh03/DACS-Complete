                    ...
                    <div class="container">
                        <form>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div style="width:460px;" class="mt-3">
                                        <label for="textInput1" class="form-label" style="font-weight: 500;">Họ và tên
                                            (có dấu) <span class="ic_sao" style="color: red;">*</span></label>
                                        <!-- <div class="ic_sao" style="color: red;">*</div> -->
                                        <input type="text" class="form-control" id="textInput1"
                                            placeholder="VÍ DỤ: NGUYỄN VĂN BẢO">
                                    </div>
                                    <div style="width:460px;" class="mt-3">
                                        <label for="textInput1" class="form-label" style="font-weight: 500;">Số điện
                                            thoại <span class="ic_sao" style="color: red;">*</span></label>
                                        <input type="text" class="form-control" id="textInput1"
                                    ...
                                    <div style="width:460px;" class="mt-3">
                                        <label for="textInput1" class="form-label" style="font-weight: 500;">Địa chỉ
                                            email <span class="ic_sao" style="color: red;">*</span></label>
                                        <input type="text" class="form-control" id="textInput1"
                                ...
                                <div class="col-md-6">
                                    <div style="width:460px;" class="mt-3">
                                        <label for="textInput1" class="form-label"
                                            style="font-weight: 500;">Ngày/tháng/năm sinh <span class="ic_sao"
                                    ...
                                    <div style="width:460px;" class="mt-3">
                                        <label for="textInput1" class="form-label" style="font-weight: 500;">Số
                                            CMND/Passport <span class="ic_sao" style="color: red;">*</span></label>
                                        <input type="text" class="form-control" id="textInput1"
                                            placeholder="Vui lòng nhập số điện thoại...">
                                    </div>
                                    <div style="width:460px" class="mt-3">
                            ...
                            <div class="button_chuatungkham">
                                ...
                                <button type="submit" class="btn btn-primary"
                                    style="background-color:rgb(58, 178, 247); border-color: rgb(58, 178, 247);">Tạo
                                    mới</button>
                            </div>
                        </form>
                    </div>
