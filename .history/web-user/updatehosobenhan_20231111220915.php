                        ...
                        <form method="POST" action="insert_benhnhan.php" onsubmit="return validateNgaySinh();">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div style="width:460px" class="mt-3">
                                        ...
                                        <select class="form-control" id="phuongXa" name="phuongXa">
                                            ...
                                            foreach ($phuongXaOptions as $quanHuyenOption => $phuongXaList) {
                                                foreach ($phuongXaList as $option) {
                                                    echo "<option value=\"$option\"";
                                                    if ($option === $phuongXa) {
                                                        echo " data-quanhuyen=\"$quanHuyenOption\" selected";
                                                    }
                                                    echo ">$option</option>";
                                                }
                                            }
                                        ...
                                        <script>
                                            function loadPhuongXa() {
                                                ...
                                                var phuongXaOptions = <?php echo json_encode($phuongXaOptions); ?>[selectedDistrict];
                            ...
                            <div class="button_chuatungkham">
                                ...
                                <button type="submit" class="btn btn-primary"
                                    style="background-color:rgb(58, 178, 247); border-color: rgb(58, 178, 247); margin-top: 20px"
                                    onclick="checkChanges()">Cập
                                    nhật</button>

                                <script>
                                    var initialFormData = {
                                        hoTen: "<?php echo htmlspecialchars($hoTen); ?>",
                                        soDienThoai: "<?php echo htmlspecialchars($soDienThoai); ?>",
                                        ngheNghiep: "<?php echo htmlspecialchars($ngheNghiep); ?>",
                                        email: "<?php echo htmlspecialchars($email); ?>",
                                        ngaySinh: "<?php echo htmlspecialchars($ngaySinh); ?>",
                                        gioiTinh: "<?php echo htmlspecialchars($gioiTinh); ?>",
                                        soCMND: "<?php echo htmlspecialchars($soCMND); ?>",
                                        danToc: "<?php echo htmlspecialchars($danToc); ?>",
                                        diaChi: "<?php echo htmlspecialchars($diaChi); ?>",
                                        tinhThanh: "<?php echo htmlspecialchars($tinhThanh); ?>",
                                        phuongXa: "<?php echo htmlspecialchars($phuongXa); ?>",
                                        quanHuyen: "<?php echo htmlspecialchars($quanHuyen); ?>"
                                    ...
                                    function checkChanges() {
                                        ...
                                        if (JSON.stringify(currentFormData) === JSON.stringify(initialFormData)) {
                                            // Không có sự thay đổi, hiển thị thông báo hoặc thực hiện hành động mong muốn
                                            alert('Không có sự thay đổi để cập nhật.');
                                        } else {
                                            // Có sự thay đổi, thực hiện hành động cập nhật thông tin
                                            // Gọi hàm cập nhật hoặc submit form tại đây
                                            alert('Có sự thay đổi, thực hiện hành động cập nhật.');
                                            // Gọi hàm cập nhật hoặc submit form tại đây
                                        }
                                    }
                                </script>
