                                ...
                                <div class="col-md-6">
                                    ...
                                    <div style="width:460px" class="mt-3">
                                        ...
                                        <select class="form-control" id="quanHuyen" name="quanHuyen"
                                            ...
                                            <?php
                                            // Mảng lưu trữ quận/huyện và phường/xã của Hà Đông
                                            $haDongDistricts = array(
                                                "Quận Hà Đông" => array("Yên Nghĩa", "Hà Cầu", "Vạn Phúc", "Yết Kiêu"),
                                                // Thêm thông tin quận/huyện và phường/xã khác nếu cần
                                            );

                                            foreach ($haDongDistricts as $district => $phuongXaOptions) {
                                    ...
                                    <div style="width:460px" class="mt-3">
                                        ...
                                        <select class="form-control" id="phuongXa" name="phuongXa">
                                            <!-- Tạo các option mới sau khi quận/huyện được chọn -->
                                            <option value="" selected disabled hidden>Chọn xã phường</option>
                                            <?php
                                            // Thêm các option cho dropdown phường/xã
