...
<head>
    ...
    <link rel="stylesheet" href="./assest/css/thongtincanhan.css">
        ...
        <div class="style_header">
            <div class="content-introduce mt-4 p-5">
                <div class="map container">
                    ...
                    <p class="cl-brown">hồ sơ bệnh nhân</p>
                    ...
                    <div class="content-mid-box1">
                        ...
                        <div class="right">
                            <div class="thongtincanhan">
                                <p>Nguyên Danh Điệp</p>
                                <p>11-11-2003</p>
                                <p>Nam</p>
                                <p>0383692419</p>
                                <p>tuanminhh203@gmail.com</p>
                                <p>Kinh</p>
                                <p>Yen Nghĩa, Hà Đông, Hà Nội</p>
                            </div>
                        </div>
                    </div>
                    <div class="content-mid-box2">
                        <div class="content-mid-box2-1 d-flex">
                            <button class="action-button delete">Xóa</button>
                            <!-- Nút sửa -->
                            <button class="action-button edit">Sửa</button>
                        </div>
                        <div class="content-mid-box2-2">
