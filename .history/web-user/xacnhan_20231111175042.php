                    ...
                    <div class="right22">
                        <div class="patient-info">
                            <div class="patient-info-item">
                                <p>Họ tên: Nguyễn Danh Điệp</p>
                                <p>Ngày sinh: 04/11/2003</p>
                                <p>Email: 21012491@st.phenikaa-uni.edu.vn</p>
                                <p>Mã số BHYT: Chưa cập nhật</p>
                            </div>
                            <div class="patient-info-item">
                                <p>Giới tính: Nam</p>
                                <p>CMND: 034203004397</p>
                                <p>Dân tộc: Kinh</p>
                                <p>Địa chỉ: Tổ 15 Yên Nghĩa, Phường Yên Nghĩa, Quận Hà Đông, Thành phố Hà Nội</p>
                            </div>
                        </div>
                    </div>
                    <div style="display: flex;">
                        <div class="right3">
                        <a href="" style=" text-decoration: none; "><p style="font-size: 20px;">Quay lại</p></a>
                        </div>
                        <div class="right4">
                            <div class="right41">
                            ...
                            <div class="right42">
                                <a href="" style=" text-decoration: none; color: white;">Xác nhận</a>
                            </div>
                        </div>
                    </div>
                </div>
